...
public class PageSearchChildResultFragment extends Fragment{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //new code
        rvCars = (RecyclerView) view.findViewById(R.id.rvCars);
    ...
    public void setUpUI() {
        ...
        //new code
        CarsAdapter adapter = new CarsAdapter(PageSearchChildResultFragment.this.getActivity(), cars);
            ...
            public void onItemClick(View itemView, int position, ImageView carImage, TextView carInfoTextView) {
                ...
                if(carInfoFragment == null || !carInfoFragment.getCarID().equals(selectedCarID)) {
                    ...
                    if (mDualPane) {
                        ...
                        Pair<View, String> p1 = Pair.create((View) carImage, "carImage" + position);
                        Pair<View, String> p2 = Pair.create((View) carInfoTextView, "carTitle" + position);
